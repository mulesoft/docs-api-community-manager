...
Improve the performance of pages and components in your Salesforce Experience Cloud site by using the https://help.salesforce.com/s/articleView?language=en_US&id=data_platform_cache.htm&type=5[platform cache, role=external, window=blank].
...
* https://help.salesforce.com/s/articleView?language=en_US&id=data_platform_cache.htm&type=5[Salesforce Platform Cache documentation, role=external, window=blank]
