...
The pages of your API Community Manager (ACM) portal are designed by adding and configuring Lightning Components in the Builder.
...
Each of the ACM Lightning Components has different configuration options and adds different functionality to the portal.
...
Button Border Radius:: Selects the radius of the button border. A larger radius makes the button look more rounded.
...
Card Border:: Specifies the thickness of the card borders.
Card Border Radius:: Specifies the radius of the card borders. A larger radius makes the cards look more rounded.
Card Shadow:: Specifies the shadow beneath the card.
API Details Button Label:: Enables you to set the label of the *API Details* button. Default is `API Details`.
Learn More Button Label:: Enables you to set the label of the *Learn More* button. Default is `Learn More`.

== API Carousel

The *API Carousel* component shows a horizontally scrollable set of API cards.

Show Buttons:: Shows the *API Details* button on each card. If the button is not shown, users can click anywhere on the card to show the API details.
...
Show Arrows:: Shows arrows on the right and left sides of the carousel. Clicking the arrows scrolls through the cards.
Arrow Size:: Specifies the size of the arrows on the right and left sides.
Show Dots:: Shows dots below the cards. Clicking the dots scrolls through the cards.
Card Height:: Specifies the card height.
Card Margin:: Specifies the amount of margin space around each card.
Card Border:: Specifies the thickness of the card borders.
Card Border Radius:: Specifies the radius of the card borders. A larger radius makes the cards look more rounded.
...
Filter Condition (Advanced):: Filters APIs using package names, field names such as "API name" or "API description," and comparison of strings to those fields.
API Details Button Label:: Enables you to set the label of the *API Details* button. Default is `API Details`.
Learn More Button Label:: Enables you to set the label of the *Learn More* button. Default is `Learn More`.
...
Show Documentation Pages:: Shows the documentation pages for the API.
Link Hover Color:: Specifies the color of links when the cursor hovers over them.
Button Text Color (Optional):: Specifies the color of text on buttons.
Button Hover Text Color (Optional):: Specifies the color of text on buttons when the cursor hovers over them. Default is the button text color.
Headline Font Family (Optional):: Specifies the font family of the API console headline.
Error Color (Optional):: Specifies the color of error messages.
Method Label Get Background Color:: Specifies the background color of the labels of *GET* methods.
Method Label Get Color:: Specifies the color of the labels of *GET* methods.
Method Label Post Background Color:: Specifies the background color of the labels of *POST* methods.
Method Label Post Color:: Specifies the color of the labels of *POST* methods.
Method Label Put Background Color:: Specifies the background color of the labels of *PUT* methods.
Method Label Put Color:: Specifies the color of the labels of *PUT* methods.
Method Label Delete Background Color:: Specifies the background color of the labels of *DELETE* methods.
Method Label Delete Color:: Specifies the color of the labels of *DELETE* methods.
Method Label Patch Background Color:: Specifies the background color of the labels of *PATCH* methods.
Method Label Patch Color:: Specifies the color of the labels of *PATCH* methods.
Method Label Options Background Color:: Specifies the background color of the labels of *OPTIONS* methods.
Method Label Options Color:: Specifies the color of the labels of *OPTIONS* methods.
Method Label Head Background Color:: Specifies the background color of the labels of *HEAD* methods.
Method Label Head Color:: Specifies the color of the labels of *HEAD* methods.
