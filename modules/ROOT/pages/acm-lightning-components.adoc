...
These Lightning components include both the components available in all Salesforce Communities, and the ACM Lightning components available only in ACM.
...
Override URL:: If set, overrides the default *API Details* button URL to the API main page in favor of linking to other information that you want the user to see first, such as documentation or marketing collateral.
...
The *API Console Documentation* component shows the Anypoint Exchange documentation about an API.
