...
The ACM Search Box component enables users to search both for content that exists in Community Cloud, such as articles, announcements, and forum posts, and content that exists in Anypoint Platform, such as APIs and client applications. Results from the search are presented in the <<acm-search-results>> component.
...
You can specify values for the following parameters of the ACM Search Results:
