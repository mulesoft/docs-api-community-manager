...
Users can select an API instance in the *Credential source* list to populate the client ID and client secret from that instance automatically, or select *Custom credentials* to enter the client ID and client secret manually.
