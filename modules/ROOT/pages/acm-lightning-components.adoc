...
The API Catalog search and the <<acm-search-box>> component are not the same searches. The ACM Search Box component offers advanced search features not available in the API Catalog search.
