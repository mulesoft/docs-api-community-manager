...
The Integrated Search Input component enables users to search data integrated from both Community Cloud and Anypoint Platform.

You can specify values for the following parameters of the Integrated Search Input:
...
The example portals and defaults have one Integrated Search Input and one Integrated Search Response Page. This is the best practice to minimize the chance of misconfigurations.

The Integrated Search Input parameter Linked Result Page specifies the search results page. That page must have an Integrated Search Response Page component to display the search results.

The Integrated Search Response Page component shows only results of the content types specified in the Search Areas parameters of the Integrated Search Input component. If a content type is not selected then the search results page does not display any search results of that content type.

IMPORTANT: The current version of the integrated search does not include CMS articles in the search results.

Search results are sorted by relevance. The current relevance ranking uses the date that the APIs and other results were most recently modified.
...
== Integrated Search Response Page

The Integrated Search Response Page shows results after a user enters a search.

You can specify values for the following parameters of the Integrated Search Response Page:

Component Title:: Specifies the title for the search response page.
