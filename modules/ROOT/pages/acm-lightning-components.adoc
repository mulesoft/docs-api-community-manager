...
== API Access Requester [[api-access-requester]]
...
The API Catalog component offers API consumers an interactive way to explore all the available APIs and API Groups in an API community. It shows API cards in rows and columns, divided into pages, and controls to filter the displayed APIs and API Groups by categories and search terms. Each card shows an API or API Group. The catalog is suitable for displaying and exploring large numbers of API versions.
...
== Application Analytics Graph [[application-analytics-graph]]
...
The component shows the application description, application URL, redirect URIs, client ID, client secret, and contracts with APIs and API Groups.
...
Specifications may be uploaded as either RAML or OAS, and the other version is automatically generated. Due to small differences in the RAML and OAS formats, the automatically generated version might have small inconsistencies with the uploaded version.
