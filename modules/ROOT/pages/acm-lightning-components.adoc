...
Specifications may be uploaded as RAML, OAS 2.0, or OAS 3.0. When a RAML version is uploaded, an OAS 2.0 version is automatically generated. When an OAS 2.0 or OAS 3.0 version is uploaded, a RAML version is automatically generated. Due to small differences in the RAML and OAS formats, the automatically generated version might have small inconsistencies with the uploaded version.
