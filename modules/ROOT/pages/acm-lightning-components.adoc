...
These categories and values are written as semicolon-separated pairs such as `Country=Argentina;Payment=Credit`. Commas can be used to separate multiple values for the same category such as `Country=Argentina,Spain;Payment=Credit`.
