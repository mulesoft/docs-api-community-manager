...
The ACM Search Box component enables users to search data integrated from both Community Cloud and Anypoint Platform.
...
The ACM Search Results component shows results after a user enters a search.
