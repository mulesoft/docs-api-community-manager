...
To design your API Community Manager portal, open the Builder and add ACM Lightning Components as described in xref:customize.adoc[API Community Look and Feel Customization].
