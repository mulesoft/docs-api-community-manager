...
The API catalog search and the <<acm-search-box>> component are not the same searches. The API catalog search is a basic search of APIs and API groups, and the ACM Search Box component offers advanced search features to search all assets in your API community.
