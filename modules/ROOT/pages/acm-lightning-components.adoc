...
The API Catalog search and the <<acm-search-box>> component are not the same searches. While the API Catalog searches inside your API catalog, the ACM Search Box component offers advanced search features to search your entire API Community.
