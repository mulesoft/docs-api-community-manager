...
These Lightning components include both the Lightning components available in all Salesforce Communities, and the API Community Manager Lightning components only available in API Community Manager.
