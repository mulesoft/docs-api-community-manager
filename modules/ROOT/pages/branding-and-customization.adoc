...
Select *Community Builder* in the ACM administrator interface. By default, the Community Builder displays the *Home* page and the Pages drop-down list displays *Home*. You can select the Pages drop-down list to display a list of community pages and specify a different page for customization.
