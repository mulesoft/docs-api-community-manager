...
Select *Community Builder* in the API Community Manager (ACM) administrator interface. By default, the Community Builder displays the *Home* page and the Pages drop-down list displays *Home*. You can select the Pages drop-down list to display a list of community pages and specify a different page for customization.
...
For additional component information, refer to xref:acm-lightning-components.adoc[ACM Lightning Components] and the Salesforce Community Cloud https://help.salesforce.com/articleView?id=rss_component_reference_table.htm&type=5[Components] documentation.

Components that are typically used in *Home* pages include:

* *Headline*: Specifies title and banner text.
* *Navigation Menu*: Displays main menu bar options. You can update *Max Items to Display (2-15)*, *Menu Item Alignment*, and use the *Navigation Menu* to display, add, remove, and customize options. *Home* is always present and always the first item. The following properties can be customized:
...
* *Rich text editor*: Used to create and display fixed text. The content is authored with a WYSWYG editor.
* *HTML editor*: Used to create and display advanced or complex HTML content. The content is written directly in HTML.
