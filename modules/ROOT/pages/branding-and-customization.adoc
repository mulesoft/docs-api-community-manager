...
For additional component information, refer to xref:acm-lightning-components.adoc[ACM Lightning Components] and 
the Salesforce Community Cloud https://help.salesforce.com/articleView?id=rss_component_reference_table.htm&type=5[Components] documentation.

Components that are typically used in *Home* pages include:

* *Headline*: Specifies title and banner text.
* *Navigation Menu*: Displays main menu bar options. You can update *Max Items to Display (2-15)*, 
