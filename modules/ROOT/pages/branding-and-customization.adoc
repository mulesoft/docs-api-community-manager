...
the Salesforce Community Cloud https://help.salesforce.com/articleView?id=rss_component_reference_table.htm&type=5[Community Components^] documentation.

Components that are typically used in *Home* pages include:

* https://help.salesforce.com/articleView?id=rss_headline.htm&type=5[Headline^]
* https://help.salesforce.com/articleView?id=rss_setup_nav_menu.htm&type=5[Navigation Menu^]: You can update *Max Items to Display (2-15)*, 
...
** *Page*
** *Publicly available*
* https://help.salesforce.com/articleView?id=rss_cms_collection.htm&type=5[CMS Collection^] 
* *API Carousel*: Displays APIs and API versions that are available to the community from Anypoint Exchange.
* https://help.salesforce.com/articleView?id=community_builder_rich_text_component.htm&type=5[Rich text editor^]
* https://help.salesforce.com/articleView?id=rss_html_editor.htm&type=5[HTML editor^]
...
site's *Text Case*.
* https://help.salesforce.com/articleView?id=community_builder_theme_adjust.htm&type=5[Theme Settings^]
