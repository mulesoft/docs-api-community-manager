...
https://help.salesforce.com/s/articleView?language=en_US&id=community_designer_overview.htm&type=5[Experience Builder, role=external, window=blank] enables
...
In the Anypoint API Community Manager control panel, click *Shortcuts to applications* and select *Site Builder* to
open your site for editing. With Site Builder you can edit each page in
...
Site Builder's interface contains the pages list, component palette,
...
which are described in https://help.salesforce.com/s/articleView?language=en_US&id=community_builder_manage_pages_overview.htm&type=5[Manage Your Community's Pages and Their Properties in Experience Builder, role=external, window=blank].
...
the Salesforce Experience Cloud https://help.salesforce.com/s/articleView?language=en_US&id=rss_component_reference_table.htm&type=5[Components, role=external, window=blank] documentation.

Components typically used in home pages include:

* https://help.salesforce.com/s/articleView?language=en_US&id=rss_headline.htm&type=5[Headline, role=external, window=blank]
* https://help.salesforce.com/s/articleView?language=en_US&id=rss_cms_collection.htm&type=5[CMS Collection, role=external, window=blank]
* API Carousel
+
...
+
* https://help.salesforce.com/s/articleView?language=en_US&id=community_builder_rich_text_component.htm&type=5[Rich text editor, role=external, window=blank]
* https://help.salesforce.com/s/articleView?language=en_US&id=rss_html_editor.htm&type=5[HTML editor, role=external, window=blank]
* https://help.salesforce.com/s/articleView?language=en_US&id=rss_setup_nav_menu.htm&type=5[Navigation Menu, role=external, window=blank]
...
+
* https://help.salesforce.com/s/articleView?language=en_US&id=community_builder_theme_adjust.htm&type=5[Theme Settings, role=external, window=blank]

You can adjust community styling by editing the CSS rules. Next to the *Theme*
title, click the *Theme* list, and click *Edit CSS*.

Refer to https://help.salesforce.com/s/articleView?language=en_US&id=community_builder_theme_customize.htm&type=5[Customize Your Experience Site Theme, role=external, window=blank].
...
* https://help.salesforce.com/s/articleView?language=en_US&id=community_builder_general_settings.htm&type=5[General, role=external, window=blank]
* https://help.salesforce.com/s/articleView?language=en_US&id=community_builder_theme.htm&type=5[Theme, role=external, window=blank]
* *SEO*
+
...
Refer to the https://help.salesforce.com/s/articleView?language=en_US&id=community_builder_general_settings.htm&type=5[Experience Builder Settings, role=external, window=blank] help topic for additional information.

== See Also

You can find further information in the Salesforce Experience Cloud documentation:

* https://help.salesforce.com/s/articleView?language=en_US&id=community_designer_customize_templates.htm&type=5[Customize Sites with Experience Builder, role=external, window=blank]
* https://help.salesforce.com/s/articleView?language=en_US&id=networks_resources.htm&type=5[Experience Cloud Overview, role=external, window=blank]
* Salesforce Trailhead training: https://trailhead.salesforce.com/content/learn/projects/set-up-a-community/brand-the-community[Community Branding, role=external, window=blank]
* Salesforce Trailhead training: https://trailhead.salesforce.com/content/learn/projects/communities_theme_layout[Build a Custom Theme Layout Component for Experience Builder Sites, role=external, window=blank]
