...
The https://help.salesforce.com/articleView?id=community_designer_overview.htm&type=5[Community Builder, role=external, window=blank] enables
...
pages, and its general, theme, and SEO settings.

In the API Community Manager (ACM) Control Panel, the *Community Builder* shows
