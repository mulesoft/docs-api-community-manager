...
Select *Community Builder* in the API Community Manager (ACM) Control Panel. By default, the
...
* *API Details Button*: Enables users to access details about an API.
...
* *Learn More Button*: Enables users to access a custom page with additional information about the API.
