...
In the API Community Manager (ACM) control panel, the *Community Builder* link
...
which includes Salesforce Community Cloud components, such as Headline or
Featured Topics, and ACM-specific components, such as API Carousel or API
