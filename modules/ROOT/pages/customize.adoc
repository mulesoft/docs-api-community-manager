...
The *Pages* list enables you to create new pages with the *New Page* option.

A new page can be an *Object Page* or *Standard Page*. An *Object Page* is used
...
The *Components* lightning bolt icon displays the component palette, which
...
The *Theme* paintbrush icon offers these general branding parameters:
