...
* Search API specifications in the API Console
* Search API documentation pages
* Search Custom fields
* Enable advanced links for search results to link to specific tabs of an API details page, such as the API Console.
