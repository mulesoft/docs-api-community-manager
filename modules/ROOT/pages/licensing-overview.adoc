...
* 10 Custom Objects
* 10 API calls per day to the Salesforce Digital Experience site
...
You can find more information about *Salesforce Customer Community Plus Login License Unlimited Edition* in the Salesforce Experience Cloud documentation page https://help.salesforce.com/s/articleView?language=en_US&id=users_license_types_communities.htm&type=5[Communities User Licenses, role=external, window=blank].
