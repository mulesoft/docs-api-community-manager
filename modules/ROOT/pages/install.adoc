...
* xref:set-up-domain.adoc[Manual Setup: Set Up and Register a Domain and Enable Communities]
* xref:deploy-domain.adoc[Manual Setup: Deploy Your Domain]
* xref:control-panel.adoc[Manual Setup: Enable API Community Manager Control Panel]
* xref:data-bridge.adoc[Manual Setup: Set Up the Data Bridge]
* xref:cache.adoc[Manual Setup: Configure the Platform Cache]
