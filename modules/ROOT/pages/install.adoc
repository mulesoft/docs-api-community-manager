...
An instance of API Community Manager connects to only one Anypoint Platform organization. The Anypoint user connects to one or more instances of ACM, possibly including sandbox instances and instances in other Salesforce organizations.
