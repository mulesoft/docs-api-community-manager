...
. Navigate to *Setup*, use *Quick Find* to go to *Change Data Capture*, navigate to *Entities* > *Change Manually* > *Available Entities*, and move *AnypointContracts* to the *Selected Entities* list, this action will enable the polling for this particular object.
...
. Click *Manage Records* in the *ACM Community Configuration Metadata* to add a record.
. Click *New*
. Set *Label* to your API community's name and press tab to auto complete the *ACM Community Config Metadata Name*
