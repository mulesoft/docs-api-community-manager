...
. Navigate to *Setup*, use *Quick Find* to go to *Change Data Capture*, navigate to *Entities* > *Change Manually* > *Available Entities*, and move *AnypointContracts* to the *Selected Entities* list, which enables polling on this object.
...
. Set *Label* to your API community's name and press tab to autocomplete the *ACM Community Config Metadata Name*.
