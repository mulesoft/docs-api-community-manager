...
. Navigate to Access Management and select Users
. Grant the impersonated Anypoint user (the user will be the email of the salesforce admin) the *Manage Contracts* permission for each environment under the Api Manager section.
