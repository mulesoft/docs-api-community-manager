...
+
If the relay is not configured, notification emails are sent from a Salesforce domain with a sender email address in your organization's domain. The actual sender domain and sender email address domain do not match, and many email providers mark the notification emails as spam.
