...
If you discover a security vulnerability, follow the steps in https://help.mulesoft.com/s/article/How-to-Report-Vulnerabilities-or-Security-Issues-on-Mule-Products[How to Report Vulnerabilities or Security Issues on Mule Products, role=external, window=blank] to send a report to the Salesforce Security Team at https://security.salesforce.com/contact[security.salesforce.com/contact] with detailed steps to reproduce the vulnerability.

== See Also

* https://security.salesforce.com/[Salesforce Security, role=external, window=blank]
