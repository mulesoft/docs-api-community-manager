...
If you discover a security vulnerability, follow the steps in https://help.salesforce.com/s/articleView?id=001115824&type=1[How to Report Vulnerabilities or Security Issues on MuleSoft Products] to send a report to https://security.salesforce.com/contact[Salesforce Security] with detailed steps to reproduce the vulnerability.

== See Also

* https://security.salesforce.com/[Salesforce Security]
