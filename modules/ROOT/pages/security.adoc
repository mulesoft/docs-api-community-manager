...
API Community Manager is part of Anypoint Platform and each member user of the API Community Manager portal has an identity in Anypoint Platform, which is also used as their API Community Manager account.
