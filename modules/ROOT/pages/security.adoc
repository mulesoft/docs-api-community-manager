...
If you discover a security vulnerability, send a report to security@salesforce.com with detailed steps to reproduce the vulnerability.

== See Also

* https://help.mulesoft.com/s/article/How-to-report-vulnerabilities-on-Mule-applications[How to Report Vulnerabilities on Mule Products, role=external, window=blank]
