...
=== 1. Set Up and Register a Domain [[set-up-and-register-a-domain]]
...
=== 2. Enable Communities Inside Your Organization [[enable-communities-inside-your-organization]]
...
=== 3. Make Your Domain Available to Your Users [[make-your-domain-available-to-your-users]]
...
After you create a community, you must create a profile to specify user permissions.
