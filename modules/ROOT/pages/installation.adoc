...
. Log in into your https://login.salesforce.com/[Salesforce Organization, role=external, window=blank].
...
=== 2. https://help.salesforce.com/articleView?id=networks_enable.htm&type=5[Enable Communities Inside Your Organization, role=external, window=blank] [[enable-communities-inside-your-organization]]
