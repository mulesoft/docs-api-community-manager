...
* <<configure-api-commmunity-manager>>
...
== Configure API Commmunity Manager [[configure-api-community-manager]]

To open the API Community Manager, select *API Community Manager App* from the *App Launcher*. The App Launcher icon 
is the first icon displayed in the main navigation bar.
