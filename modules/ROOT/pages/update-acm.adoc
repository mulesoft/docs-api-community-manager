...
For information about upgrades, see xref:notifications.adoc[Important Notifications].

After you upgrade using this process, you cannot undo the installation and return to a previous version. Follow this best-practice workflow:
...
. Install the new package in the developer sandbox and test it.
. Discard the developer sandbox.
. Install the new package in the staging sandbox and test it.
. Install the new package in your production environment.
