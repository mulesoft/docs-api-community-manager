...
Upgrading from a package version before 1.76 requires mandatory configuration updates. When the new package is installed, user access to assets in the community is disabled. When the configuration is complete, user access to asssets in the community is enabled.
