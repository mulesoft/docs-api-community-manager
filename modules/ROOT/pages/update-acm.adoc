...
. If the query returns any results, change the status of the users listed by the query to Active with the https://help.salesforce.com/articleView?id=000336144&type=1&mode=1[reactivate a user] instructions.
