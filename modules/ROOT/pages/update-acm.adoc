...
API Community Manager follows the standard support policy for MuleSoft cloud offerings, and only the latest version of API Community Manager 2.x is supported. API Community Manager 1.x reached End of Life (EOL) on August 14, 2021 and is not supported.
