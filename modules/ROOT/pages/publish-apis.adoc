...
The API or API Group editing page opens when you add an API or API Group to the community.
...
The new API or API Group version shows the message *This is only visible for you*, indicating *Administrators only* visibility. Consumer developers cannot see this API or API Group version preview.
...
+
The API is still listed in *APIs in this Community*. The new version has visibility *Administrators Only*.
. Preview the API.
. In the API Community Manager control panel, select *Manage APIs*.
