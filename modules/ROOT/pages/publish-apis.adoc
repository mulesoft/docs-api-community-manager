...
As an API Community Manager (ACM) community administrator, you can add and publish APIs and minor and major updates from Anypoint Exchange into your community. 
