...
The API version is now listed in the *APIs in this Community* section. *Visibility* is set to *Admin Only*, the API version has no icon, and the *Description* is blank. The following sections include information for updating the visibility, icon, and description information.
