...
An ACM community administrator imports APIs, new API versions, and minor API updates from their Exchange organization to their community, reviews them, and publishes them.

== Import APIs

Open the ACM administrator interface and select the *Manage APIs* tab at the top left.

On this tab you can manage what APIs from Exchange are presented in your community and their metadata and visibility.
...
The previous API version 3 remains in all communities where it was published without any changes.

In the ACM administrator interface, select *Manage APIs* at the top.

The previous API version 3 remains unchanged in the section *APIs in this Community*.

The new API version 4 is listed in the section *APIs in Exchange*.

To add version 4 to the community, click the *Add to Community* button to the right of the API version name.

The API version 4 is now listed in the section *APIs in this Community*.

Click the *Edit* button to the right of the API version 4 name and set the *Icon*, *Description*, *Visibility*, and *Marketing Page* as you did for version 3.

Preview the API, and then set *Visibility* to *Registered users* or *Public*.

Consumer developers now see API version 4 in the API carousel on the community site.

To mark version 3 as deprecated, click the *Edit* button to the right of the API version 3 name, add `[DEPRECATED]` to the end of the *API Name*, and click the *Apply* button in the bottom right.

To remove version 3 from your community, click the *Remove* button to the right of the API version 3 name, and in the dialog box click *Remove* again to confirm. Consumer developers now do not see API version 3 in the API carousel on the community site.
