...
. Open the API Community Manager control panel and select *Manage APIs*. From this tab, you can manage the APIs in your community, including their metadata and visibility.
...
. In the API Community Manager control panel, click *Community Builder*. Community Builder displays a preview of
...
. In the API Community Manager control panel, select *Manage APIs*. The previous API version remains unchanged in
