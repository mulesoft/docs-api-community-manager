...
. Select the paintbrush icon in the sidebar navigation to open the *Theme* page.
. Select the drop-down arrow in the corner of the page navigation bar and select *Edit CSS*.
