...
[NOTE]
--
* Installing, updating, or configuring Anypoint API Community Manager must be done by a user account with the *System Administrator* profile in the API Community Manager Salesforce organization. This is a prerequisite step.

* Support for Mulesoft Government Cloud is only available in API Community Manager version 2.4.x and earlier.
-- 
