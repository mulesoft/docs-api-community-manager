...
To perform a new install of the API Community Manager package in your API Community Manager Salesforce Organization, follow the steps below. To update an existing API Community Manager installation, refer to xref:update-acm.adoc[Update API Community Manager].
