...
If your site has a custom request access implementation, to update the application selector, dispatch this event:
...
If your site has a custom request access implementation and does not dispatch the event, each time a user adds an application, the user must refresh the page to show the application in the *Application* menu.
