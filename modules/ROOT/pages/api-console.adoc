...
If the site has a custom request access implementation and does not dispatch the event, after a user adds an application, showing the application in the *Application* menu requires refreshing the page.
