...
. Click *Navigation Items* in the left panel, highlight *ACM Administrator* under the *Available Items* box, and use the arrow buttons to move it to the *Selected Items* box. 
. Click *Save*.
