...
With ACM, you can create, organize, and publish content, including news, tutorials, developer 
blog posts, and events, for your community.

== Create a New Article in SalesforceCMS

NOTE: You can also author ACM content in https://help.salesforce.com/articleView?id=communities_cms_connect.htm&type=5[an external CMS system through CMS Connect]. 
...
The https://help.salesforce.com/articleView?id=rss_component_koa_kokua_components.htm&type=5[Salesforce Community Cloud documentation] describes additional ways to add articles to collections, and includes more advanced categorization capabilities using topics and rules.
...
. Scroll to the carousel to which your new article was added and select it. The new article is displayed in the carousel.
