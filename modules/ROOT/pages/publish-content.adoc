...
The *Salesforce CMS* interface enables a team such as marketing or business development to own the production and publication of content articles in a single place, and re-use the content across multiple communities.

Click the name of the workspace where you would like to create a new article.
