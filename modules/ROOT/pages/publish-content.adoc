...
This content is stored in https://help.salesforce.com/articleView?id=community_managed_content_overview.htm&type=5[Salesforce content management system (CMS)] articles.
...
. In the ACM Control Panel, select *Manage CMS Content*. The Salesforce Community Cloud *Content Management* interface is displayed.
...
. Return to the ACM Control Panel and select *Manage CMS Content*. The Salesforce Community Cloud *Content Management* interface is displayed, which provides a list of your community's articles.
. Select *Collections*.
...
. Return to the ACM Control Panel and select *Community Builder*. A preview of your community's site is displayed.
...
. Select *Finish*.
. To use your new collection on your community site, go to the ACM Control Panel and select the *Community Builder* link.
