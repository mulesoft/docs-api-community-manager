...
The https://help.salesforce.com/articleView?id=community_managed_content_collections.htm&type=5[Salesforce Community Cloud documentation] describes additional ways to add articles to collections, and includes more advanced categorization capabilities using topics and rules.
