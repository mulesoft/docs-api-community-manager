...
. In *Setup*, search for *Identity Provider* using the *Quick Find* box and click *Identity Provider*.
...
. Set *Token Valid for* to 60 minutes or lower, for Anypoint the default timeout of the token is 60 minutes.
