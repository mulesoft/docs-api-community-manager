...
For detailed information about creating secret groups and adding certificates, refer to xref:anypoint-security::asm-secret-group-creation-task.adoc#create-a-secret-group[Create a Secret Group (Anypoint Platform), role=external, window=_blank].
...
Reauthenticate the data bridge as described previously.
