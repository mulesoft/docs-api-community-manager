...
If developers can't find the answer they are looking for, they submit a support case and see activity on the case, just as they would for any of your organization's products. This is a logical next step in treating APIs as products.
...
Personalize the community with the Community Builder, a drag-and-drop editor that allows you to create and customize the experience down to the pixel.
