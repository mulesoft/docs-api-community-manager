...
API Community Manager is powered by *https://www.salesforce.com/products/experience-cloud/overview/[Salesforce Experience Cloud, role=external, window=blank]* and provides customization, branding, marketing, and engagement capabilities to serve the different needs of your developer audiences. Use API Community Manager for rich presentation of APIs cataloged in https://docs.mulesoft.com/exchange/[Anypoint Exchange], and to manage client applications, API access credentials, and consumption metrics.

See these useful resources to get up to speed with the capabilities of Salesforce Experience Cloud:

* https://help.salesforce.com/articleView?id=networks_resources.htm&type=5[Experience Cloud Product Documentation, role=external, window=blank]
* https://trailhead.salesforce.com/en/content/learn/trails/communities[Experience Cloud Trailhead, role=external, window=blank]
...
Personalize your community look and feel, branding, and site structure by using https://help.salesforce.com/articleView?id=community_designer_overview.htm&type=5[Experience Builder, role=external, window=blank], a drag-and-drop editor that enables you to create and customize the user experience at every level of detail. Experience Builder makes it easy to create a tailored experience using pre-existing Lightning components and simple clicks, or using the full flexibility of HTML and CSS for precise pixel-perfect experiences.
