...
. Configure the member and guest user settings automatically with default settings with the *Fix* buttons in the xref:diagnostics.adoc#user-access-tab[API Community Manager diagnostics user access tab].
. Configure the member and guest user settings manually with custom settings with these steps.
...
. In *Setup*, search for *Users* using the *Quick Find* box and click *Users/Profiles*.
...
. In *Object Settings*, edit the object permissions to match those shown in the following table.
. Click *Save*.
...
. Configure sharing settings for members and guests automatically with default settings with the *Fix* buttons in the xref:diagnostics.adoc#user-access-tab[API Community Manager diagnostics user access tab].
. Configure sharing settings for members and guests manually with custom settings with these steps.
...
. Configure user registration automatically with default settings with the *Fix* buttons in the xref:diagnostics.adoc#user-access-tab[API Community Manager diagnostics user access tab].
. Configure user registration manually with custom settings with these steps.
