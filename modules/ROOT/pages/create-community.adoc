...
.. From the *Digital Experience* page, click *Builder*.
.. Click the *Settings* drop-down, enter `register`in the *Quick Find* box, and select *Register*.
...
.. From the *All Custom Metadata Types* page, select *ACM Community Configuration Metadata*.
.. From the *ACM Community Configuration Metadata* page, click *Manage ACM Configuration Metadata*.
.. Select a metadata record from the list and click *Edit*.
.. Select the *RegistrationRequireApproval* checkbox and click *Save*. 

If there's no metadata record listed in the *Manage ACM Configuration Metadata* page:
