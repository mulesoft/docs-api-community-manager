...
+
You might need to reenter your login credentials to complete the installation of this package.
...
Your community's content configuration controls the forums, moderation rules, Chatter tracking for APIs, Salesforce CMS, and Salesforce CRM content of your published community.
...
=== Guest User Profile Permissions and Configuration
...
=== Member User Profile Permissions and Configuration
