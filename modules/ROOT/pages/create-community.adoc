...
Before configuring member and guest profiles and permissions, open *Setup* > *User Management Settings* and ensure *Enhanced Profile User Interface* is enabled.
