...
Anypoint API Community Manager enables you to customize and adjust the exact details of branding, look and feel, and site structure of your API community, using a simple point-and-click approach.
