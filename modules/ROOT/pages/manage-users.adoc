...
Consumer developers self-register for access to your API Community Manager. You can then approve user registrations to give them access to the restricted sections of your community. 
