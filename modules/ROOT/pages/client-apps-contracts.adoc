...
When a consumer developer creates a new application, they can provide an additional description. If the API or API Group uses the OAuth 2.0 authentication mechanism, the consumer developer can provide an OAuth 2.0 redirect URI.
