...
The structure of your API community is defined by your community pages, the Lightning components contained in each, and the links between them. You can define your own site structure and user journeys throughout your API community with these elements, tailored to your specific needs and desires.

== Typical Site Structure

To configure your API community according to the typical site structure, organize it into these pages:
...
+
Contains the full catalog of APIs and API groups available in your community, for consumers to explore and discover (*API Catalog* component).
...
== Configure the API Group Page Variation [[configure-api-group-page-variation]]
...
. Scroll down to open the *Advanced* section, and set these values:
