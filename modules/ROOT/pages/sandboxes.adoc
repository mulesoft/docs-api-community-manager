...
and return to a previous version.

Follow the best-practice workflow by creating safe sandbox environments and using them to test each
upgrade before installing the upgrade in your production environment.
