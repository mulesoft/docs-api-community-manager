...
. Go to *ACM Control Panel*, click *Manage CMS Content*, and click *Topics*.
...
Chatter tracking allows creating discussions on specific objects like APIs. To enable Chatter tracking for APIs, use these steps.
...
The self-register component allows guest users to self-register in your community to become members. If you're not using any of the ACM out-of-the-box templates, use these steps to add the ACM-specific self-registration component.
