...
Chatter tracking enables your community to create discussions on specific objects like APIs. To use Chatter tracking for APIs:
...
The self-register component enables guest users to self-register in your community to become members. If you're not using any of the ACM out-of-the-box templates, follow these steps to use the ACM-specific self-registration component.
