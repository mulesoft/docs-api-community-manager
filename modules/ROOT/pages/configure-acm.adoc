...
The self-register component enables guest users to register themselves as members of your community. If you're not using any of the ACM out-of-the-box templates, follow these steps to use the ACM-specific self-registration component:
