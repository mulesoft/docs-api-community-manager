...
. Set *Redirect URIs* to the URL from the Authentication Provider configuration. To find it, navigate
to *Salesforce Setup* -> *Auth. Providers* -> *Anypoint* -> *Callback URL*.
. *User Grant Types*: Select *Authorization Code*, *Refresh Token*, *Full Access*, and *Background Access*.
