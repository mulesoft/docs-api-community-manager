...
After you create a community, you must create the different user profiles for your community Guests and Members, so that you can control access and visibility to APIs and content. 

=== Configure Guest User Access [[configure-guest-user-access]]

In this section, you will be creating the profile to be assigned to Guests Community Users (users that are not signed-in).
...
In this section, you will be creating the profile to be assigned to Members of your Community (users that will sign-in your community).
