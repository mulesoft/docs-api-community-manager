...
https://docs.mulesoft.com/eu-control-plan/platform-access-eu[hosted within the EU, role=external, window=_blank], 
...
* Named Credentials URL when you authenticate the <<authenticate-the-external-data-source>>: Change `https://anypoint.mulesoft.com` to `https://eu1.anypoint.mulesoft.com`.
