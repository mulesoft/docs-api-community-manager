...
. Set the *Consumer Key* to the application ID of the connected app created in Anypoint. This ID was returned by the UI at the end of the step <<create-a-connected-app-with-the-user-interface>> or returned by the API call at the end of the step <<create-a-connected-app-with-an-api-call>>.
. Set the *Consumer Secret* to the application secret of the connected app created in Anypoint. This secret was returned by the UI at the end of the step <<create-a-connected-app-with-the-user-interface>> or returned by the API call at the end of the step <<create-a-connected-app-with-an-api-call>>.
