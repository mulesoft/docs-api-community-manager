...
NOTE: Support for Mulesoft Government Cloud is available in the latest version of API Community Manager, but with limitations. For more information, see xref:connectivity-govcloud.adoc#limitations[Limitations].
