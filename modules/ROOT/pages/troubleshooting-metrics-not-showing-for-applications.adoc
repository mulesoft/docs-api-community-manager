...
If the metrics aren't showing for client applications on the *My Applications* details page, ensure that you have the *Monitoring Viewer* permissions. 
...
. Click *Next*.
. Select all business groups and click *Next*.
