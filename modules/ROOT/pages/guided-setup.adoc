...
The Anypoint administrative user who performs the guided setup must have multi-factor authentication disabled. To disable it, in *Access Management* > *Users* > the user's page > *Settings*, enable *Exempt from MFA requirement*.
