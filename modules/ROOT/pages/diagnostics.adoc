...
These configuration options work only for the default API Community Manager configuration. If you have a different configuration that uses public groups and rules, do not click this button or use this diagnostic tool for the member user profile.
