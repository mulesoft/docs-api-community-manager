...
The *ACM Communities* section shows each of your ACM communities.
...
Each ACM community has options to open the community and to open the community builder, and shows three diagnostics:
...
. *Published assets status* shows if any assets in ACM incorrectly point to Exchange assets that no longer exist.
