...
1. Verify that your Anypoint organization has the API Community Manager (ACM) entitlement. Log in to your Anypoint Platform organization and navigate in your browser to `+https://anypoint.mulesoft.com/accounts/api/profile+`. Check that under the *Entitlements* property the `apiCommunityManager` value is `true`.
