...
. Open the Salesforce Application Launcher.
. Use the search bar to find and open the *API Community Manager Diagnostics*.
...
.. Confirm that *Connectivity with Anypoint* shows the URL your API community uses to access Anypoint and a green check.
+
...
+
Each community shows *Community status*, whether the community is *Public*, and the *Published assets status*, and options to open the community or open the community builder. If some of your communities are not public, or some of your communities are not yet implemented, then this information is visible here.
+
