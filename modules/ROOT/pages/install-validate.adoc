...
. If you are using Java Web Tokens and not impersonation, verify the Exchange External Data Source.
...
. If you are using impersonation and not Java Web Tokens, verify the Exchange External Data Source status is *Authenticated*.
.. Open the Application Launcher.
.. Enter *API Community Manager*.
.. Open *Setup*.
