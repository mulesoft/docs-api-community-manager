...
In an API Community, APIs and API documentation are published from Anypoint Exchange, and articles are published from the https://help.salesforce.com/s/articleView?language=en_US&id=community_managed_content_overview.htm&type=5[Salesforce content management system (CMS), role=external, window=blank].
