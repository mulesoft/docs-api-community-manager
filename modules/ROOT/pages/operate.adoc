...
In an API Community, APIs and API documentation are published from Anypoint Exchange, and articles are published from the https://help.salesforce.com/articleView?id=community_managed_content_overview.htm&type=5[Salesforce content management system (CMS)].
...
All of these actions are performed in the API Community Manager (ACM) Control Panel:

image::control-panel.png[ACM Control Panel]

To open the ACM Control Panel at any time, open the Salesforce *App Launcher* and select *API Community Manager*.
