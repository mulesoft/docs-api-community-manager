...
In an API Community, APIs and API documentation is published from Anypoint Exchange, and articles are published from the https://help.salesforce.com/articleView?id=community_managed_content_overview.htm&type=5[Salesforce content management system (CMS)].
