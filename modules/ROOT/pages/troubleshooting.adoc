...
API Community Manager sends notification emails when an API contract is approved or revoked. If you are not receiving emails, follow the steps for reviewing user and automated process permissions.
