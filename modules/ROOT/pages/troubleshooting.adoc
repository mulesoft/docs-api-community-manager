...
If installation of Anypoint API Community Manager shows a `Missing feaure` error, ensure digital experiences (previously known as communities) are enabled in your API Community Manager Salesforce organization.
