...
If you receive a `Missing feaure` error when you install Anypoint API Community Manager, ensure digital experiences (previously known as _communities_) are enabled in your API Community Manager Salesforce organization.
