...
.. In the API Community Manager control panel, click *Shortcuts to applications* and select *Site Administration*. Click the *Members* tab.
+
...
* For complex automation by using declarative group assignment, use Salesforce https://help.salesforce.com/s/articleView?language=en_US&id=sf.flow.htm&type=5[Flows, role=external, window=blank].
