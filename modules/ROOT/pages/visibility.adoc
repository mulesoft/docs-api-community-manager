...
=== Process Builder for Simple Automation

Use Salesforce https://help.salesforce.com/articleView?id=sf.process_overview.htm&type=5[Process Builder, role=external, window=blank] for simple automation such as adding each new user to a default public group.

=== APEX Triggers for Complex Automation
