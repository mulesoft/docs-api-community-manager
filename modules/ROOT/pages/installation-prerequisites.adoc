...
Follow the steps in xref:https://help.salesforce.com/s/articleView?id=sf.networks_enable.htm&type=5[Enable Digital Experiences] to enable digital experiences inside your Salesforce organization.
