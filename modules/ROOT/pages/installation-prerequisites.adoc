...
+
If you are using the EU cloud, navigate in your browser to `+https://eu1.anypoint.mulesoft.com/accounts/api/profile+`.
+
If you are using MuleSoft Government Cloud, navigate in your browser to `+https://gov.anypoint.mulesoft.com/accounts/api/profile+`.
