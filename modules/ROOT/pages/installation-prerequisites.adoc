...
.. If you are using the US cloud, navigate in your browser to `+https://anypoint.mulesoft.com/accounts/api/profile+`.
+
If you are using the EU cloud or MuleSoft Government Cloud, substitute the correct URL for your management plane.
...
The following instructions use URLs for the US cloud that begin with `+https://anypoint.mulesoft.com/+`. If you are using the EU cloud or MuleSoft Government Cloud, substitute the correct URL for your management plane.
