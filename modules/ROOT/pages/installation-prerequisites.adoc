...
+
If you don't see any roles in the list, refer to the Salesforce knowledge article https://help.salesforce.com/articleView?language=en_US&type=1&mode=1&id=000322715[Add roles to the role hierarchy, role=external, window=_blank] for instructions to create a role in your organization. The role "Salesforce CRM Content User" can be added as a string.
...
. Navigate to the correct URL for your cloud:
+
