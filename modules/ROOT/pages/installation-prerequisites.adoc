...
Installation requires a Salesforce API Community Manager organization admin user with a role.
...
== API Community Manager Entitlement

Installation requires Anypoint API Community Manager entitlement for your Anypoint organization.
...
== A Domain with Enabled Communities
