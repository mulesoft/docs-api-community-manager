...
. Log in to your ACM https://login.salesforce.com/[Salesforce Organization, role=external, window=blank].
...
Community admins, community members, and guest users can access an ACM community by using the latest versions of these browsers:
