...
+
If you don't see any roles in the list, refer to the Salesforce knowledge article https://help.salesforce.com/s/articleView?id=000322715&language=en_US&mode=1&type=1[Add roles to the role hierarchy, role=external, window=_blank] for instructions to create a role in your organization.
+
...
+
If you don't see this team, refer to the Exchange Viewer permission steps in xref:guided-setup.adoc#configure-users[Configure Users] for instructions to create it.
