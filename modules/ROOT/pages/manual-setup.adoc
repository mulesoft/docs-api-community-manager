...
. In the left panel, click *Navigation Items*.
+
Under *Available Items*, move these items to the *Selected Items* box:
* *API Curator*
* *Member Management*
* *Diagnostics*
* *Guided Setup*
...
. Verify that the API Community Manager control panel displays correctly by navigating to *App Launcher* > *API Community Manager*.
The app shows the *API Curator*, *Member Management*, *Diagnostics*, and *Guided Setup* tabs.
+
