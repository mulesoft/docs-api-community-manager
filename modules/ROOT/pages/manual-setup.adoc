...
. In *Exchange Viewers*, set a new External group called `Community User` and save it. Note: If you work with different business groups, you must create a new external group for each business group in your organization.
