...
To set up the latest version of Anypoint API Community Manager, use the xref:guided-setup.adoc[guided setup]. To set up previous versions manually, follow these steps.
