...
To set the API forums to display each user's name and not their nickname, open the API Community Manager control panel, click *Shortcuts to applications* and select *Site Administration*. Click *Preferences* and disable *Show nicknames*.

== See Also

* Salesforce documentation: https://help.salesforce.com/s/articleView?language=en_US&id=networks_moderation_overview.htm&type=5[Experience Cloud Site Moderation Strategies and Tools, role=external, window=blank]
